...
int main(int argc, char *argv[]){
  ...
  cout << "RtA:" << endl << RtA << endl;
  cout << "RtB:" << endl << RtB << endl;
  cout << "RtC:" << endl << RtC << endl;
  ...
  cout << "camera pos1: " << endl << worldPosA << endl;
  cout << "camera pos2: " << endl << worldPosB << endl;
  cout << "camera pos3: " << endl << worldPosC << endl;
...
/*
  Mat src = imread("checkerbox.bmp");
  for(int i = 0; i < 4; i++){
    circle(src, Point((*a).at<double>(i, 0), (*a).at<double>(i, 1)), 5, Scalar(0, 0, 255), CV_FILLED);
    circle(src, Point((*b).at<double>(i, 0), (*b).at<double>(i, 1)), 5, Scalar(0, 0, 255), CV_FILLED);
    circle(src, Point((*c).at<double>(i, 0), (*c).at<double>(i, 1)), 5, Scalar(0, 0, 255), CV_FILLED);
  }
  imwrite("points.jpg", src);
*/
}
